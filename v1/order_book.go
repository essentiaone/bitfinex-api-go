...
func (s *OrderBookService) Get(pair string, limitBids, limitAsks int, noGroup bool) (*OrderBook, error) {
	...
	if err != nil {
		return nil, &ErrorHandler{FuncWhere: "Get order book", FuncWhat:"newRequest", FuncError: err.Error()}
	}
	...
	if err != nil {
		return nil, &ErrorHandler{FuncWhere: "Get order book", FuncWhat:"do", FuncError: err.Error()}
	}
